...
// Botón para forzar cierre de todos los modales (debug)
const btnCloseAll = document.querySelector("#btnCloseAll");
if(btnCloseAll){ btnCloseAll.addEventListener('click', ()=> closeAllModals()); }
